...
function About() {
    return (
        <div>
            <h1>What is a <i>TODULO?</i> </h1>
            <p className='content'>
                The definition is a simple one. It’s a list of tasks you need to complete or things that you want to do. That is its a simple<b> ToDo-List Application</b>
            </p>
            <p>
            ...
            <h1>The Benefits of Using a <i>TODULO</i>:</h1>
            <p>
            ...
            <p><b>Improves your memory:</b> A to do list acts as an external memory aid. It’s only possible to hold a few pieces of information at one time. Keep a to do list and you’ll be able to keep track of everything, rather than just a few of the tasks you need to do. Your to do list will also reinforce the information, which makes it less likely you’re going to forget something.</p>
            <p><b>Increases productivity:</b>A to do list allows you to prioritize the tasks that are more important. This means you don’t waste time on tasks that don’t require your immediate attention. Your list will help you stay focused on the tasks that are the most important.</p>
            <p><b>Helps with motivation: </b>To do lists are a great motivational tool because you can use them to clarify your goals. You can divide your long-term goal into smaller, more achievable short-term goals and as you tick each one off your list, your confidence will increase.</p>
        </div>
    )
}
